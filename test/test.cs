...
public abstract partial class C1
{
	...
	delegate void D();
	event D? E1;
	event D E2 { add { E1 += value; } remove { E2 -= value; } } // TODO
...
class C3
{
	...
	{
		var (y) when x is (int or char) => 0, // TODO
		>= 1 and < 2 or not null => 0, // TODO
	};
